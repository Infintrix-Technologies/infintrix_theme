...
$(document).ready(() => {
    ...
    const minimize_icon_svg = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-minimize"><path d="M8 3v3a2 2 0 0 1-2 2H3m18 0h-3a2 2 0 0 1-2-2V3m0 18v-3a2 2 0 0 1 2-2h3M3 16h3a2 2 0 0 1 2 2v3"></path></svg>'
    ...
    const themeToggleButton = document.createElement("li");
		...
		function tryAddingButton() {
			...
			if (fullscreenButton) {
              ...
              document.documentElement.setAttribute("data-theme", theme_to_switch.toLowerCase());
              themeToggleButton.innerHTML = theme_to_switch === "Light" ? moon_icon_svg : sun_icon_svg;
